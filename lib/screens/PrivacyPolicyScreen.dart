                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '$appName collects information to provide better services to all our users. We collect information in the following ways:',
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'We use the information we collect from all of our services to provide, maintain, protect and improve them, to develop new ones, and to protect $appName and our users.',
                        style: const TextStyle(
                          fontSize: 14,
                          color: AppColors.textSecondary,
                          height: 1.6,
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'We work hard to protect $appName and our users from unauthorized access to or unauthorized alteration, disclosure or destruction of information we hold. We use industry-standard encryption protocols (SSL/TLS) for data transmission.',
                        style: const TextStyle(
                          fontSize: 14,
                          color: AppColors.textSecondary,
                          height: 1.6,
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'Depending on your location, you may have the right to access, correct, or delete your personal data. You can manage your preferences directly from the account settings in the $appName app.',
                        style: const TextStyle(
                          fontSize: 14,
                          color: AppColors.textSecondary,
                          height: 1.6,
